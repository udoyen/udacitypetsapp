...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * Used to monitor user activity to present  a dialogue box
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("pet", "The URI: " + mCurrentPetUri);
        ...
        // have uri of the pet so change app bar to say "Edit Pet"
        // Otherwise if this is a new pet, uri is nul so change app bar to say "Add a Pet"

        // if the intent DOW NOT contain a pet conten URI, then we kn know that we are
        // creating a new pet
    ...
    private void savePet() {
        ...
        //Determine if this is a new existing pet by checking if mCurrentPetUri is null or not
        if (mCurrentPetUri == null) {
            ...
            // Show a taost message depending on whether or not the update was successful.
            if (rowAffected == 0) {
                ...
                // Otherwise, the update was successful and we display a toast.
                Toast.makeText(this, getString(R.string.editor_insert_pet_successful),
                        Toast.LENGTH_SHORT).show();
            }
        }
