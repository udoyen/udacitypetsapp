...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new PetCursorAdapter(this, null, true);
        ...
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //TODO: Finish this
                int myId = (int) mCursorAdapter.getItemId(position);

                // Create an editor intent
    ...
    private void showDeleteAllPetsDialog() {
        ...
        builder.setPositiveButton(R.string.delete_all, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // User clicked delete all button so delete
        ...
        builder.setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // User cancelled with clicking "Cancel"
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    private void deleteAllPets() {
        ...
        if ( rowsDeleted == 0 ) {
            ...
            Toast.makeText(this, R.string.error_deleting_all_pets, Toast.LENGTH_SHORT).show();
        } else {

            // Other wise
            Toast.makeText(this, R.string.success_deleting_all_pets, Toast.LENGTH_SHORT).show();
